...
public class TestsEtape2 {

    Sentence_itf []		sentence;
	static int		    numeroTest;
    static TestsEtape2  app;
    

    public TestsEtape2(Sentence_itf[] s) {
        this.sentence = s;
    }
    ...
    public static void main(String argv[]) {
        ...
        Sentence_itf[] sentences = new Sentence_itf[10];
        for (int i = 1; i <= 10; i++) {
            Sentence_itf s = (Sentence_itf)Client.lookup("ObjetTest" + i);// + Integer.toString(i));
            if (s == null) {
        ...
        TestsEtape2 test = new TestsEtape2(sentences);
    ...
    public String printEtatActuel(String str, int i) {
        ...
        String lock = ((SharedObject) this.sentence[i]).getLock().toString();
