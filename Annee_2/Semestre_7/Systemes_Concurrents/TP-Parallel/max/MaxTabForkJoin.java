    ...
    static class PartialMax extends RecursiveTask<Integer> {
        ...
        public Integer compute() {
            ...
            if (end-start > threshold) {
                ...
                PartialMax sp1 = new PartialMax(array, start, halfSize, threshold);
                PartialMax sp2 = new PartialMax(array, start + halfSize, end, threshold);
                sp1.fork();
                sp2.fork();
                return Math.max(sp2.join(), sp1.join());
            } else {
