...
variable : typeStruct idents PTVIRG { (print_endline "variable : typeStruct IDENT PTVIRG") }

idents : IDENT { (print_endline "idents : IDENT") }
		| IDENT VIRG idents { (print_endline "idents : IDENT VIRG idents") }
...
/* A FAIRE : Completer pour ajouter les autres formes d'instructions */
               instruction : expression PTVIRG { (print_endline "instruction : expression PTVIRG") }
							 | si sinon   { (print_endline "instruction : si sinon") }
...
si : SI PAROUV expression PARFER bloc { (print_endline "si : SI PAROUV expression PARFER bloc") }

sinon : /* Lambda, mot vide */ { (print_endline "sinon : /* Lambda, mot vide */") }
        | SINON bloc { (print_endline "sinon : SINON bloc") }

/* A FAIRE : Completer pour ajouter les autres formes d'expressions */
expression : unairefac ENTIER { (print_endline "expression : ENTIER") }
...
unairefac : /* Lambda, mot vide */ { (print_endline "unairefac : /* Lambda, mot vide */") }
			| unaire { (print_endline "unairefac : unaire") }
