...
public class ExempleSchema1 {
	...
	public static void main(String[] args)
	{
		...
		// Afficher le schema en texte
		System.out.println("(Affichage en texte) Le schéma est composé de : ");
		AfficheurTexte aff = new AfficheurTexte();
		s12.afficherTexte(aff);		System.out.println();
		s23.afficherTexte(aff);		System.out.println();
		s31.afficherTexte(aff);		System.out.println();
		barycentre.afficherTexte(aff);	System.out.println();
		
		// Créer l'écran
		Ecran ecran = new Ecran("ExempleSchema1", 600, 400, 20);
		ecran.dessinerAxes();
		
		// Dessiner le schéma sur l'écran
		s12.dessiner(ecran);
		s23.dessiner(ecran);
		s31.dessiner(ecran);
