...
public class Segment {
	...
	*/
	...
	/** Dessiner le segment sur un écran
	 * @param ecran écran sur lequel on dessine le segment
	 */
	...
	/** Afficher le segment au format texte
	 * @param afficheur afficheur texte
	 */
	public void afficherTexte(AfficheurTexte afficheur) {
		afficheur.dessinerLigne(this.extremite1.getX(), this.extremite1.getY(), this.extremite2.getX(), this.extremite2.getY(), this.couleur);
	}
