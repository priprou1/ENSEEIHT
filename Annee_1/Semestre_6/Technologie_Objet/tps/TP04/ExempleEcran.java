...
class ExempleEcran {
	...
	public static void main(String[] args) {
		...
		// Affichage en SVG
		AfficheurSVG afficheur = new AfficheurSVG("Schema", "Schema composé de 1 Point, 1 Ligne et 1 Cercle", 400, 250);
		
		afficheur.dessinerPoint(1, 2, Color.green);
		afficheur.dessinerLigne(6, 2, 11, 9, Color.red);
		afficheur.dessinerCercle(4, 3, 2.5, Color.yellow);
		afficheur.dessinerTexte(1, -2, "Premier dessin", Color.blue);
		
		afficheur.ecrire();
		afficheur.ecrire("schema");
	}
