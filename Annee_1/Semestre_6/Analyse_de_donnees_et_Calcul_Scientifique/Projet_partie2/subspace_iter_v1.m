...
function [ W, V, n_ev, it, itv, flag ] = subspace_iter_v1( A, m, percentage, eps, maxit )
    ...
    while (~conv & k < maxit),
        ...
        %% Projection de Rayleigh-Ritz appliqué sur la matrice A et les vecteurs orthonormés de V
