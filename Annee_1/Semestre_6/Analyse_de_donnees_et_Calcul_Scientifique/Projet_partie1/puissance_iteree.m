...
err1 = 0;       % indication q  ue le calcul est satisfaisant
                % on stoppe quand err1 < eps 
disp('** COMPLET ** CONSIGNES EN COMMENTAIRE **')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Ecart relatif entre les deux valeurs propres trouvees = %1.2e\n', ...
    abs(lambda1 - lambda2)/max(abs(lambda1), abs(lambda2)));
