...
% -------------------------------------
% Réponses aux questions 2.2:
% Valable pour h de l'ordre de 10-4, Quand h est trop petit l'erreur
% augmente, ce qui est contre-intuitif
% Quand précision double valable pour h de l'ordre de 10-8
% -------------------------------------
...
% -------------------------------------
% Réponses aux questions 3.2:
% Valable pour h de l'ordre de 10-2, Quand h est trop petit l'erreur
% augmente, ce qui est contre-intuitif
% C'est aussi un h plus grand que précedement donc il est plus performant
% -------------------------------------
