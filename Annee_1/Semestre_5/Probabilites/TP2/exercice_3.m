...
bornes = fonctions_TP2_proba('partitionnement_frequences',selection_frequences);

% Codage arithmetique :
[borne_inf,borne_sup] = ...
fonctions_TP2_proba('codage_arithmetique',texte,selection_alphabet,bornes);
